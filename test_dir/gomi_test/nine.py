...
gyr_x_lsb = i2c.read_byte_data( ADDRESS, 0x3B+7 )
gyr_x_msb = i2c.read_byte_data( ADDRESS, 0x3B+8 )
gyr_y_lsb = i2c.read_byte_data( ADDRESS, 0x3B+9 )
gyr_y_msb = i2c.read_byte_data( ADDRESS, 0x3B+10 )
gyr_z_lsb = i2c.read_byte_data( ADDRESS, 0x3B+11 )
gyr_z_msb = i2c.read_byte_data( ADDRESS, 0x3B+12 )
